//Celeste Going
//Project 3
/*This program calculates the fare for a parking lot.
The time entered and exited is entered by the user,
and the program calculates the appropriate payment
due. The program also accounts for circumstances
such as a lost ticket or a parking pass. The program
then prints out a reciept listing the times entered
